    ...
    function renderFrame() {
        ...
        if ( state.directed ) {
            edges.forEach(function ( edge ) {
                ...
                //    to.ui.position.y,
                //    to.ui.position.z);
                //link.ui.position.set(from.ui.position.x,
                //    from.ui.position.y,
                //    from.ui.position.z);
                //var direction = new THREE.Vector3().subVectors(newTargetPos, newSourcePos);
                //link.ui.setLength(direction.length()); // Set length before normalization.
                //link.ui.setDirection(direction.normalize());
                ////link.ui.line.lineWidth = 100;
                //console.log(link.ui.line);
    ...
    function createLayout ( state ) {
        ...
        if ( typeof input === 'string' ) {
            ...
            if ( input === 'Fixed' ) {
                ...
                return new Fixed( network, state.physicsSettings );
            }
