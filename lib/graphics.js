...
function Graphics ( state ) {
    ...
    function createNodeUI(node) {
        ...
        if (!ui) {
            ...
            ui.z = layers.indexOf('l' + node.data['layer']) * state.interLayerDistance;
            console.log(state.interLayerDistance);
    ...
    function createLayout ( state ) {
        ...
        if ( typeof input === 'string' ) {
            ...
            if ( input === 'ForceDirectedLayered' ) {
                return new ForceDirectedLayered( network, state.settings );
            }
